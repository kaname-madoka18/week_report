# WorldMM / EgoLife 数据集 overview

核对日期：2026-09-22（UTC）。WorldMM 项目页：[worldmm.github.io](https://worldmm.github.io/) · [WorldMM 代码](https://github.com/wgcyeo/WorldMM)。WorldMM 的 setup 脚本下载 `lmms-lab/EgoLife`，以下整理以该数据集及其公开关联模态为范围。EgoLife 入口：[项目官网](https://egolife-ai.github.io/) · [官方博客](https://egolife-ai.github.io/blog/) · [论文 v3](https://arxiv.org/html/2503.03803v3) · [代码](https://github.com/EvolvingLMMs-Lab/EgoLife)。
