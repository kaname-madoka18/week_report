...
共 41 篇论文；已整理 41 篇；2,638 张独立视频预览图；111 个可播放短视频 case。短视频阈值为完整本地副本不超过 180 秒。相同文件被多篇论文复用时只计一次。
...
| [BEHAVIOR-1K / 2026 Challenge Demonstrations](datasets/behavior-1k/overview.html) | 2024/03/14 | 180 / 1717 | CoRL 2023 | 当前 20,000 条 episode：1952.93 小时，平均 351.53 秒，中位数 335.03 秒，范围 4.93–1525.37 秒（meta length / 30fps）。 | [300 张图](datasets/behavior-1k/preview_gallery.html) |
...
| [MIKASA / MIKASA-Robo](datasets/mikasa-robo/overview.html) | 2025-02-14 | 37 / 139 | ICLR 2026 | 可配置的 episode/延迟长度，按控制步数定义；官方分 Short/Medium/Long 三档。页面短演示仅表示播放时长，不能代替轨迹长度。 本地2段官网案例播放时长 0.50–0.83秒。 | [2 个视频 case](datasets/mikasa-robo/preview_gallery.html) |
